...
export function StatsPage() {
  ...
  // Хватает одного дня: график с одним столбиком всё равно показывает,
  // сколько малыш спал. Средние и сравнения прячутся сами, когда данных мало,
  // и рядом с каждым числом написано, по скольким дням оно посчитано.
  const sleepReady = daysWithData >= 1;
